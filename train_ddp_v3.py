"""
JaT-AudioSR V2 Training Script (Enhanced Version)
...
class TrainConfig:
    ...
    # --- 训练超参 ---
    batch_size = 30         # 单卡 Batch (总 Batch = 48)
    lr = 5e-5               # 稳健学习率
    weight_decay = 0.1
    ...
    # --- 保存与日志 ---
    save_dir_base = "checkpoints/v3_full_run"  # 基础目录
    log_dir_base = "runs/v3_full_run"          # 基础目录
