...
class TrainConfig:
    ...
    # --- Latent Perceptual Loss (MOD2 新增) ---
    ...
    consistency_weight = 0.1           # 🔥 MOD2: Hybrid Consistency Loss权重 (降低，因为数值尺度大)
    ...
    # --- 保存与日志 ---
    save_dir_base = "checkpoints/v3mod2_full_run"  # MOD2基础目录
    log_dir_base = "runs/v3mod2_full_run"          # MOD2基础目录
